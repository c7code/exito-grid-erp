...
const AdminDailyChecklist = lazy(() => import('./pages/admin/DailyChecklist'));
...
const PartnerProposalView = lazy(() => import('./pages/partner/PartnerProposalView'));
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRoles={['admin', 'commercial', 'engineer', 'finance', 'employee', 'viewer']} />}>
            <Route element={<AdminLayout />}>
              ...
              <Route path="/admin/daily-checklist" element={<AdminDailyChecklist />} />
          ...
          >
            ...
            <Route element={<PartnerLayout />}>
              ...
              <Route path="proposals/:proposalId" element={<PartnerProposalView />} />
            </Route>
          </Route>
