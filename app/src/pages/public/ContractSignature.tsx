...
export default function ContractSignature() {
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <p style={{ color: '#94a3b8', fontSize: '15px' }}>Carregando contrato...</p>
                </div>
            </div>
        );
    }
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'grid', gap: '8px' }}>
                            <div><span style={{ color: '#94a3b8' }}>Contrato:</span> <strong>#{contract?.contractNumber}</strong></div>
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: '10px', color: '#64748b', marginTop: '2px' }}>
                                    Guarde para futuras verificações
                                </div>
                            </div>
                            <span style={{
                                background: 'linear-gradient(135deg, #22c55e, #16a34a)',
                    ...
                    <div style={{
                        ...
                        fontSize: '11px', color: '#1e40af', lineHeight: '1.6', textAlign: 'left',
                    }}>
                        <strong>📋 Base Legal:</strong> Assinatura com validade jurídica conforme
                        MP 2.200-2/2001 e Lei 14.063/2020 (assinatura eletrônica avançada).
                    </div>
                    ...
                    <div style={{
                        ...
                        IP, data/hora e navegador registrados.
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div style={{
            ...
            {/* Steps */}
            <div className="no-print" style={{
                display: 'flex', justifyContent: 'center', padding: '20px 20px 0', gap: '8px',
            }}>
                {[
                    { n: 1, label: 'Revisar Contrato', icon: Eye },
            ...
            <div style={{ maxWidth: '880px', margin: '20px auto', padding: '0 16px' }}>
                ...
                {docExpanded && (
                    <div style={{
                        background: '#fff', boxShadow: '0 8px 40px rgba(0,0,0,0.3)',
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            marginBottom: '12px', boxShadow: `0 8px 20px ${accent}40`,
                        }}>
                        ...
                        <p style={{ fontSize: '13px', color: '#94a3b8', marginTop: '6px' }}>
                            Preencha seus dados e desenhe sua assinatura para confirmar.
                        </p>
                    </div>

                    <div style={{ padding: '28px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
                        <div>
                            <label style={{ display: 'block', fontSize: '13px', fontWeight: 600, marginBottom: '6px', color: dark }}>
                        ...
                        <div>
                            ...
                            <input type="text" value={signerDocument}
                        ...
                        <div style={{
                            ...
                            <input type="checkbox" checked={accepted}
                                ...
                                style={{ marginTop: '2px', cursor: 'pointer', width: '18px', height: '18px', accentColor: accent }}
                            />
                            <span style={{ fontSize: '12px', color: '#92400e', lineHeight: '1.6' }}>
                                Declaro que li e aceito todos os termos deste contrato.
                                Confirmo que possuo autoridade legal para assinar em nome da
                                empresa/pessoa identificada. Estou ciente de que esta assinatura
                                eletrônica possui validade jurídica conforme MP 2.200-2/2001 e Lei 14.063/2020.
                            </span>
                        </div>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: canSign && !signing ? `linear-gradient(135deg, ${accent}, #c2410c)` : '#e2e8f0',
                        ...
                        >
                            {signing ? (
                                <><Loader2 style={{ width: '20px', height: '20px', animation: 'spin 1s linear infinite' }} /> Processando...</>
                            ) : (
                                <><FileSignature style={{ width: '20px', height: '20px' }} /> Assinar Contrato</>
                            )}
                        </button>

                        <div style={{
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                            gap: '6px', color: '#94a3b8', fontSize: '10px',
                        }}>
                            <Lock style={{ width: '11px', height: '11px' }} />
                            IP, data/hora e navegador serão registrados para validade jurídica.
                        </div>
                    </div>
                </div>
            </div>
