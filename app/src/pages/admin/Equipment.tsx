...
import { Loader2, Truck, LayoutDashboard, Package, FileText, Clock, Zap, Wrench, ClipboardCheck } from 'lucide-react';
...
export default function EquipmentPage() {
  ...
  async function loadAll() {
    try {
      setLoading(true);
      const [eq, re, ma, dl, sv, cl, st] = await Promise.all([
        api.getEquipment(),
      ...
      // Load auxiliary data (clients & employees)
      try {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Gestão completa de equipamentos, locações, diárias, serviços, manutenções e vistorias
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        {tab === 'equip' && (
          <EquipmentList equipment={equipment} reload={loadAll} />
        )}
